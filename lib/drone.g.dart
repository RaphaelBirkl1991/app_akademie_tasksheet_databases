...
const DroneSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'obstacleAvoidance': PropertySchema(
      id: 4,
      name: r'obstacleAvoidance',
      type: IsarType.bool,
    ),
...
void _droneSerialize(
  ...
  writer.writeBool(offsets[4], object.obstacleAvoidance);
...
Drone _droneDeserialize(
  ...
  final object = Drone(
    ...
    obstacleAvoidance: reader.readBool(offsets[4]),
...
extension DroneQueryFilter on QueryBuilder<Drone, Drone, QFilterCondition> {
  ...
  QueryBuilder<Drone, Drone, QAfterFilterCondition> obstacleAvoidanceEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'obstacleAvoidance',
        value: value,
      ));
    });
  }
...
extension DroneQuerySortBy on QueryBuilder<Drone, Drone, QSortBy> {
  ...
  QueryBuilder<Drone, Drone, QAfterSortBy> sortByObstacleAvoidance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'obstacleAvoidance', Sort.asc);
    });
  }

  QueryBuilder<Drone, Drone, QAfterSortBy> sortByObstacleAvoidanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'obstacleAvoidance', Sort.desc);
    });
  }
...
extension DroneQuerySortThenBy on QueryBuilder<Drone, Drone, QSortThenBy> {
  ...
  QueryBuilder<Drone, Drone, QAfterSortBy> thenByObstacleAvoidance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'obstacleAvoidance', Sort.asc);
    });
  }

  QueryBuilder<Drone, Drone, QAfterSortBy> thenByObstacleAvoidanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'obstacleAvoidance', Sort.desc);
    });
  }
...
extension DroneQueryWhereDistinct on QueryBuilder<Drone, Drone, QDistinct> {
  ...
  QueryBuilder<Drone, Drone, QDistinct> distinctByObstacleAvoidance() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'obstacleAvoidance');
    });
  }
...
extension DroneQueryProperty on QueryBuilder<Drone, Drone, QQueryProperty> {
  ...
  QueryBuilder<Drone, bool, QQueryOperations> obstacleAvoidanceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'obstacleAvoidance');
    });
  }
